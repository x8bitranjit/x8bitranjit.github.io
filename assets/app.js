...
const DOCS = {
  ...
  /* ---- Checklists (test-case matrices; migrated from the Check-list corpus) ---- */
  'checklist/recon':              { doc:'content/checklist-recon.md', title:'Recon — Checklist', chips:['Checklist','Attack surface'] },
  'checklist/ato':                { doc:'content/checklist-ato.md', title:'Account Takeover — Checklist', chips:['Checklist','Critical: ATO'] },
  'checklist/cmdi':               { doc:'content/checklist-cmdi.md', title:'Command Injection — Checklist', chips:['Checklist','Critical: RCE'] },
  'checklist/cors':               { doc:'content/checklist-cors.md', title:'CORS — Checklist', chips:['Checklist','Cross-origin'] },
  'checklist/csrf':               { doc:'content/checklist-csrf.md', title:'CSRF — Checklist', chips:['Checklist','State-change'] },
  'checklist/depconfusion':       { doc:'content/checklist-depconfusion.md', title:'Dependency Confusion — Checklist', chips:['Checklist','Supply chain / RCE'] },
  'checklist/deser':              { doc:'content/checklist-deser.md', title:'Insecure Deserialization — Checklist', chips:['Checklist','Critical: RCE'] },
  'checklist/fileupload':         { doc:'content/checklist-fileupload.md', title:'File Upload — Checklist', chips:['Checklist','RCE / stored'] },
  'checklist/hostheader':         { doc:'content/checklist-hostheader.md', title:'Host Header Injection — Checklist', chips:['Checklist','ATO / cache'] },
  'checklist/idor':               { doc:'content/checklist-idor.md', title:'IDOR / BOLA — Checklist', chips:['Checklist','Critical: BOLA / PII'] },
  'checklist/jndi':               { doc:'content/checklist-jndi.md', title:'JNDI / Log4Shell — Checklist', chips:['Checklist','Critical: RCE'] },
  'checklist/jsfiles':            { doc:'content/checklist-jsfiles.md', title:'JavaScript Files Analysis — Checklist', chips:['Checklist','Recon / secrets'] },
  'checklist/jwt':                { doc:'content/checklist-jwt.md', title:'JWT — Checklist', chips:['Checklist','ATO / auth-bypass'] },
  'checklist/ldap':               { doc:'content/checklist-ldap.md', title:'LDAP Injection — Checklist', chips:['Checklist','Auth-bypass'] },
  'checklist/lfi':                { doc:'content/checklist-lfi.md', title:'LFI — Checklist', chips:['Checklist','Disclosure / RCE'] },
  'checklist/nosqli':             { doc:'content/checklist-nosqli.md', title:'NoSQL Injection — Checklist', chips:['Checklist','Auth-bypass / exfil'] },
  'checklist/oauth':              { doc:'content/checklist-oauth.md', title:'OAuth / OIDC / SAML — Checklist', chips:['Checklist','ATO'] },
  'checklist/openredir':          { doc:'content/checklist-openredir.md', title:'Open Redirect — Checklist', chips:['Checklist','Phishing / token theft'] },
  'checklist/pathtraversal':      { doc:'content/checklist-pathtraversal.md', title:'Path / Directory Traversal — Checklist', chips:['Checklist','Disclosure / write-RCE'] },
  'checklist/prototype':          { doc:'content/checklist-prototype.md', title:'Prototype Pollution — Checklist', chips:['Checklist','RCE / DOM-XSS'] },
  'checklist/racecondition':      { doc:'content/checklist-racecondition.md', title:'Race Condition — Checklist', chips:['Checklist','Limit-overrun / ATO'] },
  'checklist/smuggling':          { doc:'content/checklist-smuggling.md', title:'Request Smuggling — Checklist', chips:['Checklist','Desync / cache-poison'] },
  'checklist/rfi':                { doc:'content/checklist-rfi.md', title:'RFI — Checklist', chips:['Checklist','RCE'] },
  'checklist/sqli':               { doc:'content/checklist-sqli.md', title:'SQL Injection — Checklist', chips:['Checklist','Critical: RCE / dump'] },
  'checklist/ssrf':               { doc:'content/checklist-ssrf.md', title:'SSRF — Checklist', chips:['Checklist','Cloud metadata / internal'] },
  'checklist/ssti':               { doc:'content/checklist-ssti.md', title:'SSTI — Checklist', chips:['Checklist','Critical: RCE'] },
  'checklist/subtakeover':        { doc:'content/checklist-subtakeover.md', title:'Subdomain Takeover — Checklist', chips:['Checklist','Takeover / ATO'] },
  'checklist/webcache':           { doc:'content/checklist-webcache.md', title:'Web Cache Poisoning — Checklist', chips:['Checklist','Mass-XSS / DoS'] },
  'checklist/websocket':          { doc:'content/checklist-websocket.md', title:'WebSocket — Checklist', chips:['Checklist','CSWSH / ATO'] },
  'checklist/xpath':              { doc:'content/checklist-xpath.md', title:'XPath Injection — Checklist', chips:['Checklist','Auth-bypass / dump'] },
  'checklist/xss':                { doc:'content/checklist-xss.md', title:'XSS — Checklist', chips:['Checklist','ATO / session theft'] },
  'checklist/xxe':                { doc:'content/checklist-xxe.md', title:'XXE — Checklist', chips:['Checklist','File read / SSRF'] },
  'checklist/orm':                { doc:'content/checklist-orm.md', title:'ORM Injection — Checklist', chips:['Checklist','Injection'] },
  'checklist/wafbypass':          { doc:'content/checklist-wafbypass.md', title:'WAF / Filter Bypass — Checklist', chips:['Checklist','Evasion'] },
  'checklist/llm':                { doc:'content/checklist-llm.md', title:'LLM Prompt Injection — Checklist', chips:['Checklist','AI / LLM'] },
  'checklist/feat-01':            { doc:'content/checklist-feat-01.md', title:'1. Authentication & User Management — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-02':            { doc:'content/checklist-feat-02.md', title:'2. User Profile & Settings — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-03':            { doc:'content/checklist-feat-03.md', title:'3. File & Media Management — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-04':            { doc:'content/checklist-feat-04.md', title:'4. E-Commerce Features — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-05':            { doc:'content/checklist-feat-05.md', title:'5. Payment & Checkout — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-06':            { doc:'content/checklist-feat-06.md', title:'6. Order Management — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-07':            { doc:'content/checklist-feat-07.md', title:'7. Address & Location — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-08':            { doc:'content/checklist-feat-08.md', title:'8. Social & Community — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-09':            { doc:'content/checklist-feat-09.md', title:'9. CMS — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-10':            { doc:'content/checklist-feat-10.md', title:'10. Communication & Notification — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-11':            { doc:'content/checklist-feat-11.md', title:'11. Approval & Workflow — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-12':            { doc:'content/checklist-feat-12.md', title:'12. Access Control & Permission — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-13':            { doc:'content/checklist-feat-13.md', title:'13. Forms & Data Collection — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-14':            { doc:'content/checklist-feat-14.md', title:'14. Reporting & Analytics — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-15':            { doc:'content/checklist-feat-15.md', title:'15. Scheduling & Booking — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-16':            { doc:'content/checklist-feat-16.md', title:'16. Search & Discovery — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-17':            { doc:'content/checklist-feat-17.md', title:'17. Gamification & Engagement — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-18':            { doc:'content/checklist-feat-18.md', title:'18. Integration Features — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-19':            { doc:'content/checklist-feat-19.md', title:'19. Mobile & Device — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-20':            { doc:'content/checklist-feat-20.md', title:'20. Security Features — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-21':            { doc:'content/checklist-feat-21.md', title:'21. Collaboration Features — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-22':            { doc:'content/checklist-feat-22.md', title:'22. Administrative Features — Checklist', chips:['Checklist','Feature'] },
  'checklist/feat-23':            { doc:'content/checklist-feat-23.md', title:'23. Business-Specific Workflows — Checklist', chips:['Checklist','Feature'] },
  'checklist/blackbox':           { doc:'content/checklist-blackbox.md', title:'Black-Box Web App — Checklist', chips:['Checklist','Feature'] },
  'checklist/api':                { doc:'content/checklist-api.md', title:'API Master — Checklist', chips:['Checklist','API'] },
...
const NAV = [
  ...
  { kind:'section', label:'Checklists', open:false, groups:[
    { label:'Attack Test-Case Matrices', open:false, items:[
       { label:'Recon', route:'checklist/recon' },
       { label:'Account Takeover', route:'checklist/ato' },
       { label:'Command Injection', route:'checklist/cmdi' },
       { label:'CORS', route:'checklist/cors' },
       { label:'CSRF', route:'checklist/csrf' },
       { label:'Dependency Confusion', route:'checklist/depconfusion' },
       { label:'Insecure Deserialization', route:'checklist/deser' },
       { label:'File Upload', route:'checklist/fileupload' },
       { label:'Host Header Injection', route:'checklist/hostheader' },
       { label:'IDOR / BOLA', route:'checklist/idor' },
       { label:'JNDI / Log4Shell', route:'checklist/jndi' },
       { label:'JavaScript Files Analysis', route:'checklist/jsfiles' },
       { label:'JWT', route:'checklist/jwt' },
       { label:'LDAP Injection', route:'checklist/ldap' },
       { label:'LFI', route:'checklist/lfi' },
       { label:'NoSQL Injection', route:'checklist/nosqli' },
       { label:'OAuth / OIDC / SAML', route:'checklist/oauth' },
       { label:'Open Redirect', route:'checklist/openredir' },
       { label:'Path / Directory Traversal', route:'checklist/pathtraversal' },
       { label:'Prototype Pollution', route:'checklist/prototype' },
       { label:'Race Condition', route:'checklist/racecondition' },
       { label:'Request Smuggling', route:'checklist/smuggling' },
       { label:'RFI', route:'checklist/rfi' },
       { label:'SQL Injection', route:'checklist/sqli' },
       { label:'SSRF', route:'checklist/ssrf' },
       { label:'SSTI', route:'checklist/ssti' },
       { label:'Subdomain Takeover', route:'checklist/subtakeover' },
       { label:'Web Cache Poisoning', route:'checklist/webcache' },
       { label:'WebSocket', route:'checklist/websocket' },
       { label:'XPath Injection', route:'checklist/xpath' },
       { label:'XSS', route:'checklist/xss' },
       { label:'XXE', route:'checklist/xxe' },
       { label:'ORM Injection', route:'checklist/orm' },
       { label:'WAF / Filter Bypass', route:'checklist/wafbypass' },
       { label:'LLM Prompt Injection', route:'checklist/llm' },
    ]},
    { label:'Feature-Area Checklists', open:false, items:[
       { label:'1. Authentication & User Management', route:'checklist/feat-01' },
       { label:'2. User Profile & Settings', route:'checklist/feat-02' },
       { label:'3. File & Media Management', route:'checklist/feat-03' },
       { label:'4. E-Commerce Features', route:'checklist/feat-04' },
       { label:'5. Payment & Checkout', route:'checklist/feat-05' },
       { label:'6. Order Management', route:'checklist/feat-06' },
       { label:'7. Address & Location', route:'checklist/feat-07' },
       { label:'8. Social & Community', route:'checklist/feat-08' },
       { label:'9. CMS', route:'checklist/feat-09' },
       { label:'10. Communication & Notification', route:'checklist/feat-10' },
       { label:'11. Approval & Workflow', route:'checklist/feat-11' },
       { label:'12. Access Control & Permission', route:'checklist/feat-12' },
       { label:'13. Forms & Data Collection', route:'checklist/feat-13' },
       { label:'14. Reporting & Analytics', route:'checklist/feat-14' },
       { label:'15. Scheduling & Booking', route:'checklist/feat-15' },
       { label:'16. Search & Discovery', route:'checklist/feat-16' },
       { label:'17. Gamification & Engagement', route:'checklist/feat-17' },
       { label:'18. Integration Features', route:'checklist/feat-18' },
       { label:'19. Mobile & Device', route:'checklist/feat-19' },
       { label:'20. Security Features', route:'checklist/feat-20' },
       { label:'21. Collaboration Features', route:'checklist/feat-21' },
       { label:'22. Administrative Features', route:'checklist/feat-22' },
       { label:'23. Business-Specific Workflows', route:'checklist/feat-23' },
       { label:'Black-Box Web App Checklist', route:'checklist/blackbox' },
    ]},
    { label:'API', open:false, items:[
       { label:'API Master Checklist', route:'checklist/api' },
    ]},
  ]},
...
const RECENT = [
  { label:'Checklists — 35 Attack Matrices (new)', route:'checklist/sqli',    date:'Jul 2026' },
  { label:'Checklists — 24 Feature Areas (new)',   route:'checklist/feat-01', date:'Jul 2026' },
  { label:'Checklists — API Master (new)',         route:'checklist/api',     date:'Jul 2026' },
